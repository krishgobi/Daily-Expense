...
import { ChevronDown, ChevronUp, ArrowRight, Trash2, Paperclip, Receipt, Banknote, CreditCard } from 'lucide-react'
            ...
            {expandedId === expense.id && (
              <div className="border-t border-gray-100 bg-gray-50/60 px-5 py-4 dark:border-gray-800 dark:bg-gray-800/30 animate-fade-in">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <button
                    onClick={(e) => { e.stopPropagation(); setUploadError(''); setUploadingForId(uploadingForId === expense.id ? null : expense.id) }}
